...
# Generated by Powerlevel10k configuration wizard on 2025-11-18 at 15:15 JST.
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  # Default current directory color.#172
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=106
